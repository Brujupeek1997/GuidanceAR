...
if __name__ == "__main__":
    ...
    model.train(data="config.yaml", imgsz=640, epochs=500, batch=16, workers=8, device=0, optimizer="AdamW", lr0=0.001,
        ...
        fliplr=0.5, mosaic=1.0, mixup=0.1, copy_paste=0.1, save=True, plots=True, patience=25, overlap_mask=True,
        mask_ratio=2)
